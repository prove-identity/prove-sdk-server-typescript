...
let value: V3BatchGetIdentitiesResponse = {
  ...
  results: [
    {
      proveId: "4a6317c1-4855-4900-b369-bed138f4ec00",
    },
    {
      proveId: "e53c0597-1cce-4d8f-bd1b-e0a10f875ac9",
    },
  ],
};
```
...
| `results`                                                                                                                                                                                   | [components.GetBatchIdentityItem](../../models/components/getbatchidentityitem.md)[]                                                                                                        | :heavy_check_mark:                                                                                                                                                                          | The list of identity IDs associated with the client.                                                                                                                                        | [<br/>{<br/>"proveId": "4a6317c1-4855-4900-b369-bed138f4ec00"<br/>},<br/>{<br/>"proveId": "e53c0597-1cce-4d8f-bd1b-e0a10f875ac9"<br/>}<br/>]                                                |