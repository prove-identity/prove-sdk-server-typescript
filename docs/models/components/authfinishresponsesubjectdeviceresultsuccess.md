...
| `extras`                                                                                                                                                                                                                                         | [components.AuthFinishResponseSubjectDeviceResultSuccessExtras](../../models/components/authfinishresponsesubjectdeviceresultsuccessextras.md)                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                                                               | N/A                                                                                                                                                                                                                                              | {<br/>"deviceCapabilities": [<br/>"deviceCapabilities",<br/>"deviceCapabilities"<br/>],<br/>"deviceType": "deviceType",<br/>"keyType": "keyType",<br/>"rawSignals": {<br/>"fingerprint": {<br/>"key": "{}"<br/>}<br/>},<br/>"supportedUvLevel": [<br/>6,<br/>6<br/>],<br/>"trust": {<br/>"reasonCodes": [<br/>1,<br/>1<br/>]<br/>}<br/>} |
