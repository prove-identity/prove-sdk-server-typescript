 ...
 */
export function authAuthStartRequest(
  client: ProveapiCore,
  request?: components.AuthStartRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthStartRequestResponse,
    | errors.Error400
    | errors.ErrorT
    | ProveapiError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AuthStartRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v1/server/auth/start")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthStartRequestResponse$inboundSchema, {
      key: "AuthStartResponse",
    }),
