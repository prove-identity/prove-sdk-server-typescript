 ...
 */
export function authAuthContinueRequest(
  client: ProveapiCore,
  request?: components.AuthContinueRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthContinueRequestResponse,
    | errors.Error400
    | errors.ErrorT
    | ProveapiError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AuthContinueRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v1/server/auth/continue")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthContinueRequestResponse$inboundSchema, {
      key: "AuthContinueResponse",
    }),
