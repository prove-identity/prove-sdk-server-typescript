 ...
 */
export function identityV3FetchRequest(
  client: ProveapiCore,
  proveId: string,
  attributeId: string,
  ...
  Result<
    operations.V3FetchRequestResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error404
...
> {
  const input: operations.V3FetchRequestRequest = {
    proveId: proveId,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.V3FetchRequestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/fetch")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3FetchRequestResponse$inboundSchema, {
      key: "V3FetchResponse",
    }),
