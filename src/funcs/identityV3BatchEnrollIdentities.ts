 ...
 */
export async function identityV3BatchEnrollIdentities(
  client: ProveapiCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V3BatchEnrollIdentitiesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/identity/batch")();
