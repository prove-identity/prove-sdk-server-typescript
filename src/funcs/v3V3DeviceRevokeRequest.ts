 ...
 */
export function v3V3DeviceRevokeRequest(
  client: ProveapiCore,
  request?: components.V3DeviceRevokeRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V3DeviceRevokeRequestResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error404
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V3DeviceRevokeRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v3/device/revoke")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3DeviceRevokeRequestResponse$inboundSchema, {
      hdrs: true,
      key: "V3DeviceRevokeResponse",
    }),
