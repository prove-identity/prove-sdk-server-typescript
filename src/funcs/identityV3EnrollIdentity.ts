 ...
 */
export async function identityV3EnrollIdentity(
  client: ProveapiCore,
  request?: components.V3EnrollIdentityRequest | undefined,
  options?: RequestOptions,
): Promise<
  Result<
    operations.V3EnrollIdentityResponse,
    | errors.ErrorT
    | errors.Error401
    | errors.Error403
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V3EnrollIdentityRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.V3EnrollIdentityResponse$inboundSchema, {
      key: "V3EnrollIdentityResponse",
    }),
