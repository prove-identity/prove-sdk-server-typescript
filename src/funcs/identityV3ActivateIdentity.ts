 ...
 */
export async function identityV3ActivateIdentity(
  client: ProveapiCore,
  identityId: string,
  ...
  Result<
    operations.V3ActivateIdentityResponse,
    | errors.ErrorT
    | errors.Error401
    | errors.Error403
    | errors.ErrorT
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.V3ActivateIdentityRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.V3ActivateIdentityRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.V3ActivateIdentityResponse$inboundSchema, {
      key: "V3ActivateIdentityResponse",
    }),
